...
public class FileTransferServiceImpl implements FileTransferService {
    ...
    public Result getUploadingFilesDetails() throws Exception {
        com.aliyun.dingtalkstorage_1_0.Client client = FileTransferServiceImpl.createClient();
...
//                .setParentId("0")
    ...
    public Result getUuid() throws Exception {
        com.aliyun.dingtalkstorage_2_0.Client client = FileTransferServiceImpl.createClient2();
...
//                .setKeyword("keyword")
    ...
    public Result commitFiles() throws Exception {
        ...
        com.aliyun.dingtalkstorage_1_0.models.CommitFileRequest commitFileRequest = new com.aliyun.dingtalkstorage_1_0.models.CommitFileRequest()
                .setUnionId("GZXIcgIFwLVsYU56PjNEHAiEiE")
                .setUploadKey("hgHPAAAABZn5ZpUCzwAAACANWwMxAwEEoTcF2gA5I2lBRUhBcVJtYVd4bEE2aDVkVzVrYVhOck1BVE9JVDF6TndYTkd4Y0d6T0VIem1ZbC1xMEl6UUtWBqhESU5HVEFMSw")
                .setName("11.xlsx")
